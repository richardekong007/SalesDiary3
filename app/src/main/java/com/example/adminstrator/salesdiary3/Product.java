...
public class Product implements Serializable {
    ...
    public Product(int Id, String description, Double costPrice, String imgPath, Integer stock) {
        this.Id = Id;
    ...
    public Product(String description, Double costPrice, String imgPath, Integer stock) {
        this.description = description;
        this.costPrice = costPrice;
        this.imgPath = imgPath;
        this.stock = stock;
