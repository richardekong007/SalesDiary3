 ...
 */
public class InflowSummaryReport extends Fragment {
    ...
    private String[] label={"profit","Sales"};


    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle richy)
    {
        final View v=inflater.inflate(R.layout.inflowreportsummary,container,false);
        ...
        //Instantiate textViews
         chartTitle=(TextView)v.findViewById(R.id.charttitle);
                 TextView profittext=(TextView)v.findViewById(R.id.profitField),
                salesField=(TextView)v.findViewById(R.id.salesfield);
    ...
    public void createPieChart()
    {
        ...
        //populate the profit and sales entries with data
            Entries.add(new PieEntry(grandProfit.intValue(),label[0]));
            Entries.add(new PieEntry(grandSales.intValue(),label[1]));

        //create pie data set
        String pieCenterPhrase=chartTitle.getText().toString().substring(0,chartTitle.getText().toString().indexOf(" "))+" Inflow";
        ...
        //pieChart.setDescription(pieCenterPhrase);
        //undo all highligth
